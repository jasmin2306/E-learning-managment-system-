...
export const getAllCourses = createAsyncThunk("/courses/get", async () => {
  ...
  const loadingMessage = toast.loading("fetching courses...", { id: "course-action" });
  try {
...
export const createNewCourse = createAsyncThunk(
  "/courses/create",
  async (data) => {
    const loadingMessage = toast.loading("Creating course...", { id: "course-action" });
    try {
...
export const deleteCourse = createAsyncThunk("/course/delete", async (id) => {
  const loadingId = toast.loading("deleting course ...", { id: "course-action" });
  try {
